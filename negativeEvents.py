...
class DNSHeuristicConfig:
    rare_max_global_count: int = 5 
    frequent_per_src_threshold: int = 3 
    long_qname: int = 55
    many_labels: int = 6
    long_label: int = 20
...
def plot_top10(df: pd.DataFrame, value_col: str, label_col: str, title: str, out_png: Path) -> None:
    ...
    top10 = top10.sort_values(value_col, ascending=True)
